...
# Print the result.
    ...
    static function getDateTimeDifferenceInSeconds($date1,$date2){
    ...
    public static function getDurationTimeAndDistanceBetweenMultipleDistances($lat1,$long1,$lat2,$long2,$waypoints){
        ...
        $url = "https://maps.googleapis.com/maps/api/directions/json?origin=".$lat1.",".$long1."&destination=".$lat2.",".$long2."&waypoints=$waypoints&key=".GOOGLE_MAPS_KEY;
        ...
        if($output_array['status'] =="ZERO_RESULTS"){
            return false;
    ...
    static function calculateFare($base_fare,$cost_per_minute,$cost_per_distance,$ride_duration_in_seconds,$ride_distance_in_meters,$surge,$distance_unit){
       ...
       $ride_distance_in_km = $ride_distance_in_meters/1000;
