                    ...
                    <div class="content-page-header-container">
                        <div class="page-header-container-wrap">
                                ...
                                <div class="page-header-content-left">
                                    <div class="page-header-left-content">
                                        ...
                                        <?php
                                            ...
                                            if($json_data['Request']['request'] == '0')
                                            {
                                                echo '<span class="statusbtn statusBtnPending">Pending</span>';
                                            }
                                            if($json_data['Request']['request'] == '1')
                                            {
                                                echo '<span class="statusbtn statusBtnActive">Accept</span>';
                                            }
                                            if($json_data['Request']['request'] == '2')
                                            {
                                                echo '<span class="statusbtn statusBtnCancel">Reject</span>';
                                            }
                                            
                                            if($json_data['Request']['on_the_way'] == '1')
                                            {
                                                echo '<span class="statusbtn statusBtnPending">On the way</span>';
                                            }
                                            else
                                            if($json_data['Request']['arrive_on_location'] == '1')
                                            {
                                                echo '<span class="statusbtn statusBtnPending">Arrived on location</span>';
                                            }
                                        ?>
                            ...
                            <div class="header-sub-content">
                                <?php
                                    $timestamp = strtotime($json_data['Request']['created']);
                        ...
                        <div style="margin-left: -20px;">
                            <div class="items-card-container">
                                <div class="items-card-header p-0">
                                    ...
                                    <?php
                                        if(is_array($json_data['Request']) || is_object($json_data['Request'])) 
                                        { 
                                            ?>
                                                <div class="item-card-body-container" style="border-bottom: 1px solid rgb(225 227 229);"> 
                                                    ...
                                                    <div class="orderDetail">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p><span style="color:black;font-weight: 600;">Pickup Location:</span> <?php echo ucfirst($json_data['Request']['pickup_location']);?></p>
                                                            <p><span style="color:black;font-weight: 600;">Dropoff Location:</span> <?php echo ucfirst($json_data['Request']['dropoff_location']);?></p>
                                                        </div>  
                                                    </div>
                                                    <br>
                                                    <div class="orderDetail">
                                                        <div>
                                                            <?php
                                                                if($json_data['Request']['start_ride']=="1")
                                                                {
                                                                    ?>
                                                                        <p>
                                                                            <span style="color:black;font-weight: 600;">Trip Start Time:</span> 
                                                                            <?php
                                                                                echo date("M d Y h:i a", strtotime($json_data['Request']['start_ride_datetime']));
                                                                            ?>
                                                                        </p>
                                                                    <?php
                                                                }
                                                                
                                                                if($json_data['Request']['end_ride']=="1")
                                                                {
                                                                    ?>
                                                                        <p>
                                                                            <span style="color:black;font-weight: 600;">Trip End Time:</span> 
                                                                            <?php
                                                                                echo date("M d Y h:i a", strtotime($json_data['Request']['end_ride_datetime']));
                                                                            ?>
                                                                        </p>
                                                                    <?php
                                                                }
                                                                ...
                                                                if($json_data['Request']['arrive_on_location']=="1")
                                                                {
                                                                    ?>
                                                                        <p>
                                                                            <span style="color:black;font-weight: 600;">Arrive On Location Time:</span> 
                                                                            <?php
                                                                                echo date("M d Y h:i a", strtotime($json_data['Request']['arrive_on_location_datetime']));
                                                                            ?>
                                                                        </p>
                                                                    <?php
                                                                }
                                                                
                                                                if($json_data['Request']['driver_ride_response']=="1")
                                                                {
                                                                    ?>
                                                                        <p>
                                                                            <span style="color:red;font-weight: 600;">Canceled by driver:</span> 
                                                                            <?php
                                                                                echo $json_data['Request']['reason'];
                                                                            ?>
                                                                        </p>
                                                                    <?php
                                                                }
                                                                
                                                                if($json_data['Request']['user_ride_response']=="1")
                                                                {
                                                                    ?>
                                                                        <p>
                                                                            <span style="color:red;font-weight: 600;">Canceled by customer:</span> 
                                                                            <?php
                                                                                echo $json_data['Request']['reason'];
                                                                            ?>
                                                                        </p>
                                    ...
                                    <div class="item-card-body-container b--top" style="padding:0px">
                                        ...
                                        <div class="payment-card-body-container"> 
                                            <div class="orderDetail">
                                                ...
                                                <p> <?php echo $_SESSION[PRE_FIX.'currency_symbol']; ?><?php echo $json_data['Request']['estimated_fare']; ?></p>
                                            </div>
                                        </div>
