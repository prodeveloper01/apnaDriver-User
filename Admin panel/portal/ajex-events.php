...
if(isset($_GET['q']))
{
    ...
    {
        ?>
            <form name="" method="post" action="process.php?action=pushNotification">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Send Push Notification</h5>
                    <button type="button" class="close" onclick="ClosePopup();">
                        <span aria-hidden="true">
                            <i class="fal fa-times"></i>
                        </span>
                ...
                <div class="modal-body modelHeight" style="height: auto;overflow: unset;">
                    ...
                    <div class="input-email-container">
                        <div class="email-input-container">
                            ...
                            <Select class="countrySelect" name="role" required>
                    ...
                    <div class="input-email-container">
                        <div class="email-input-container">
                            <label for="address">Push Notification</label>
